...
//
// 捷徑寫的是 notes-data 的 GitHub issue，東西只存在 GitHub 那邊；本機要跑過
...
const NOTES_DATA = process.env.NOTES_DATA_DIR
  ?? join(dirname(fileURLToPath(import.meta.url)), '..', '..', 'notes-data');
...
// 只回報有意義的兩行：抓到幾則、同步了什麼。整份輸出留給直接跑 notes-data 的時候看。
