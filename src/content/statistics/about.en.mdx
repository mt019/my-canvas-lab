...
None of that is antiquarian detail. The <Term id="p-value">p value</Term> gets read as "the probability that the null is true" not because readers are careless, but because textbooks teach Fisher's logic of evidence and Neyman and Pearson's logic of decision on the same page — and those two men spent their careers arguing about exactly that. Knowing what the argument was about is worth more than one more memorised definition.
