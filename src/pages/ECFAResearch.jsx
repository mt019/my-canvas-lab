...
const ECFA_VARS = { // token-exempt
  ...
  '--ecfa-table-head-bg': 'var(--tone-rose-bg)',
  ...
  '--ecfa-badge-slate-bg': 'var(--tone-slate-bg)',
  '--ecfa-badge-slate-ink': 'var(--tone-slate-tx)',
  '--ecfa-badge-gold-bg': '#f2e3e7',
  '--ecfa-badge-gold-ink': '#945d70',
  '--ecfa-badge-green-bg': 'var(--tone-green-bg)',
  '--ecfa-badge-green-ink': 'var(--tone-green-tx)',
  '--ecfa-badge-red-bg': '#f5dfe3',
  '--ecfa-badge-red-ink': '#984f62',
  '--ecfa-badge-blue-bg': 'var(--tone-blue-bg)',
  '--ecfa-badge-blue-ink': 'var(--tone-blue-tx)',
