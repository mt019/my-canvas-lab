          ...
          <>
            ...
            <section className={`${styles.panel} ${styles.aboutPanel}`}>
              ...
              <div className={styles.aboutBody}>
                ...
                <p>
                  另一個方向是六項裡的最後一項，法實證研究。湯德宗在司改十週年論壇的致詞裡說得明白，「司法制度的比較研究與司法行為的實證研究」是規劃書選定的重點之一，籌備處 2004 年成立起就在開拓，隨即辦起「司法制度實證研究國際研討會」。早期做這件事的是黃國昌，〈律師代理對民事訴訟結果之影響〉、〈刑事第二審制度變革之影響評估〉、〈勞資爭議協調程序之實證研究〉都在這批書裡；後來主要由張永健接手做大，另設了法實證研究資料中心。方向我認為是對的，做出來的東西則要說老實話，多半還很陽春。典型的一篇長這樣。到法源用條號撈一批地方法院判決，分層隨機抽樣、人工編碼，再跑敘述統計、卡方檢定和邏輯斯迴歸，報告某種分割方式占幾成、某個變數的係數顯不顯著。〈分割共有物判決之實證研究〉從 2,702 筆抽出可用的 500 件；〈越界建築訴訟之實證研究〉撈到 1,181 筆，編碼後剩 192 筆，這 192 筆不夠跑迴歸，只好另撈一批 156 筆來補；有些交叉表分到只剩十幾二十筆觀察值，照樣下了判斷。要測民法修法有沒有改變法院行為，靠的是修法前後對照。這個對照要成立，得先假定修法前後的案件組成沒有變；那個假定寫在註腳裡，也沒有對照組。
                </p>
                <p>
                  更麻煩的是材料本身。判決書只留得住走到判決的案件，和解、撤回、根本沒進法院的那些，一開始就不在資料裡；判決書寫的是法官願意寫下來的理由，他實際上依據什麼下判斷，紙面上看不到。越界建築那一批，明確談到越界者心理狀態的判決只有 8 筆，可是故意或重大過失正是民法第 796 條的關鍵要件。這樣的材料能穩當回答的問題，比作者想問的窄得多。經濟分析那一半跟數判決那一半也常常分開走，〈越界建築之經濟分析〉2013 年、〈越界建築訴訟之實證研究〉2014 年，一篇推理論、一篇報數字，理論預測了什麼、數據驗到了什麼，接得並不緊。這些工作把現象清點出來了，離檢驗假設還有一段距離。
                </p>
                <p>
